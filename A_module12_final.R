...
setwd('/Users/korikvargas/Documents/UNH/Manipulation Data/Module12/assignment')
...
# code with components from each individual. Drew and Connor made most of the editis and comments for each question. 
# Korik ran through all code making comments and edits as needed.
